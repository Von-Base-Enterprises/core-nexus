...
from memory_service.embedding_models import (
...
async def test_mock_embedding():
    ...
    try:
        ...
        print(f"✅ Mock embedding generated successfully")
        ...
        print(f"✅ Mock batch embedding generated successfully")
...
async def test_openai_embedding():
    ...
    try:
        ...
        print(f"✅ OpenAI batch embedding generated successfully")
        print(f"   - Batch size: {len(batch_embeddings)}")
        print(f"   - All dimensions: {[len(emb) for emb in batch_embeddings]}")
...
async def test_integration_simulation():
    ...
    try:
        ...
        print(f"✅ Memory embedding generated")
