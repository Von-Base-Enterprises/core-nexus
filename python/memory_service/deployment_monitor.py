    ...
    while True:
        try:
            ...
            if response.getcode() == 200:
                ...
                print("🔗 Service URL: https://core-nexus-memory-service.onrender.com")
                print("📊 Metrics: https://core-nexus-memory-service.onrender.com/metrics")
                print("💾 Database: https://core-nexus-memory-service.onrender.com/db/stats")
                break
            else:
