...
class CoreNexusClient:
    ...
    def store_memory(self, content: str, metadata: dict[str, Any] | None = None,
                    importance_score: float | None = None, user_id: str | None = None,
    ...
    def query_memories(self, query: str, limit: int = 10, min_similarity: float = 0.3,
                      filters: dict[str, Any] | None = None, user_id: str | None = None,
...
def store_memory(content: str, metadata: dict[str, Any] | None = None, **kwargs) -> MemoryResult:
