...
class DataRelevanceAnalyzer:
    ...
    async def analyze_relevance(
        ...
        context_memories: Optional[List[MemoryResponse]] = None
    ) -> float:
        """
    ...
    async def _analyze_semantic_relevance(
        self, 
        content: str, 
        context_memories: Optional[List[MemoryResponse]]
    ) -> float:
...
class ADMScoringEngine:
    ...
    def __init__(
        ...
        weights: Optional[ADMWeights] = None,
        thresholds: Optional[ADMThresholds] = None
    ):
        self.unified_store = unified_store
