#!/usr/bin/env python3
"""
Run migration 002 directly through asyncpg
This will apply the HNSW index optimization to fix query performance
"""
...
-- Current production average: 885ms -> Expected after migration: <50ms
...
async def run_migration():
    ...
    print("🚀 Starting pgvector performance migration...")
    print("="*60)
    
    # Connect to database
    conn_string = f"postgresql://{PG_USER}:{PG_PASSWORD}@{PG_HOST}:{PG_PORT}/{PG_DATABASE}"
    ...
    try:
        ...
        print("Expected performance improvement: 885ms → <50ms queries")
        print("="*60)
